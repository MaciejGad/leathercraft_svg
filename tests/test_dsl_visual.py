...
def _dsl_rounded_regular_polygon_holes() -> bytes:
    return _compile_dsl("""
size 120 120
...
def _dsl_rounded_regular_polygon_stitches() -> bytes:
    return _compile_dsl("""
size 120 120
...
SCENARIOS: dict[str, callable] = {
    ...
    "dsl_rounded_regular_polygon_holes.png": _dsl_rounded_regular_polygon_holes,
    "dsl_rounded_regular_polygon_stitches.png": _dsl_rounded_regular_polygon_stitches,
    # --- stadium ---
